...
LeaderCar::update(float elapsedTime) {
  ...
  if (_carIndex >= 0) {
    ...
    // this part elevate where the gero::graphic::Camera look along the up axis
    // of the car
    // => without it the gero::graphic::Camera look at the ground
    // => mostly useful for a shoulder gero::graphic::Camera0
    _carPosition =
