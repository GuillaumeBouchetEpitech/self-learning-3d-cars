...
#include "SphereParticleManager.hpp"
...
SphereParticleManager::ExplosionParticle::ExplosionParticle(
...
// SphereParticleManager::TrailParticle::TrailParticle(
//   const glm::vec3& position, const glm::vec3& linearVelocity,
//   const glm::vec3& color, float scale, float life)
...
void
SphereParticleManager::initialise() {
  ...
  particlesVertices.reserve(2048);

  gero::graphics::MakeGeometries::Vertices outVertices;
  outVertices.reserve(2048);
...
void
SphereParticleManager::setMatricesData(
  const gero::graphics::Camera::MatricesData& matricesData) {
  _matricesData = matricesData;
}

void
SphereParticleManager::update(float delta) {
...
void
SphereParticleManager::emitParticles(
