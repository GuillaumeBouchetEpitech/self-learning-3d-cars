...
void FrameProfiler::stop(uint32_t totalLiveVehicles)
{
...
void FrameProfiler::set(uint32_t totalLiveVehicles, int32_t deltaTime)
{
...
const std::unordered_map<uint32_t, int32_t>& FrameProfiler::getDeltasMap() const
{
  return _deltasMap;
}

int32_t FrameProfiler::getMaxDelta(uint32_t totalLiveAgents) const
{
