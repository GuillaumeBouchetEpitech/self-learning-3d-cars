...
void
CarData::SingleTransform::lerp(
  const CarData::SingleTransform& valA, const CarData::SingleTransform& valB,
  float coef) {
...
void
CarData::CarTransform::lerp(
  const CarData::CarTransform& valA, const CarData::CarTransform& valB,
  float coef) {
...
CarData::lerp(const CarData& valA, const CarData& valB, float coef) {
  ...
  groundSensor.near = valA.groundSensor.near +
                      (valB.groundSensor.near - valA.groundSensor.near) * coef;
  groundSensor.far = valA.groundSensor.far +
                     (valB.groundSensor.far - valA.groundSensor.far) * coef;
  groundSensor.value =
    valA.groundSensor.value +
    (valB.groundSensor.value - valA.groundSensor.value) * coef;
